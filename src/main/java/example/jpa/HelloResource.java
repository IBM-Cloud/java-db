...
public class HelloResource {
	...
	public String getInformation() throws Exception, IOException {
		...
		for (String eachkey : keys) {
			if (eachkey.contains("sql") || eachkey.contains("cleardb")) {
				thekey = eachkey;
			}
		}
		if (thekey == null) {
		...
		JSONObject credentialsObj = (JSONObject) obj.get("credentials");
		String databaseHost = (String) credentialsObj.get("hostname");
		String databaseName = (String) credentialsObj.get("name");
		String port = (String) credentialsObj.get("port");
		// String user = (String) credentialsObj.get ("username");
		// String password = (String) credentialsObj.get ("password");
		// String jdbcurl = (String) credentialsObj.get("jdbcUrl");
